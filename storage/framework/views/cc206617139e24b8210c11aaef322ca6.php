...
<div class="wrapper">
    ...
    <nav class="sidebar">
        ...
        <ul class="list-unstyled menu-elements">
            <li class="active">
                <a class="<?php echo e(route('profile.show')); ?>" href="<?php echo e(route('profile.show')); ?>"><i class="fas fa-home"></i> Profile</a>
            </li>
            <li>
                <a class="scroll-link" href="#section-1"><i class="fas fa-cog"></i> Dashboard</a>
            </li>
            <li>
                <a class="scroll-link" href="#section-2"><i class="fas fa-user"></i> Application Request</a>
            </li>
            <li>
                <a class="scroll-link" href="#section-5"><i class="fas fa-pencil-alt"></i> Installment</a>
            </li>
            <li>
                <a class="scroll-link" href="#section-6"><i class="fas fa-envelope"></i> Fully Paid</a>
            </li>

            <li>
                <a href="#otherSections"   role="button" >
...
</html><?php /**PATH C:\Users\REMELOU POSTRANO\Desktop\billnwow\prototype\resources\views/about/adminnav/profile.blade.php ENDPATH**/ ?>